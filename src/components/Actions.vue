<template>
    <div class="actions">
        <div class="actions__el">
            <svg class="actions__svg"  width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="actions__el">
            <svg class="actions__svg" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
